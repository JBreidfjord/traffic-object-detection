...
class RetinaNetLoss(tf.losses.Loss):
    """Wrapper for RetinaNetBoxLoss and RetinaNetClassificationLoss."""
...
def build_head(output_filters, bias_init):
    """
    Builds the class/box prediction heads.
    
    Args:
        output_filters: Number of filters in the output layer.
        bias_init: Bias initializer for the final convolutional layer.
    
    Returns:
        A keras sequential model representing either the classification or the \
            box regression head, depending on `output_filters`.
    """
